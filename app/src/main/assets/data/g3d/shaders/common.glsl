...
[textureFlag]
#if defined(diffuseTextureFlag) || defined(specularTextureFlag)|| defined(overTextureFlag)|| defined(videoTextureFlag)
	 #define textureFlag
#endif
...
[colorOver]
#include "u_uniforms.glsl:u_overTexture"
[colorVideo]
#include "u_uniforms.glsl:u_videoTexture"